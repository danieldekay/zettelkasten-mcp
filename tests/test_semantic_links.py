...
"""
    ...
    def test_mcp_get_linked_notes_tool(self, zettel_service):
        ...
        assert result["note_id"] == central_note.id
        note_entry = result["notes"][0]
        assert note_entry["link_type"] == "extends"
        assert note_entry["link_description"] == "Testing extends relationship"
    ...
    def test_mcp_create_link_tool(self, zettel_service):
        ...
        assert "Bidirectional link created" in result["summary"]
