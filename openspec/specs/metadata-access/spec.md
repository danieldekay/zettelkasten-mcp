...
Defines the metadata read/write contract for notes. Arbitrary key-value metadata is stored in Markdown frontmatter and the SQLite `notes` table, and exposed through the structured response API.
