...
<!-- TBD: Expand with a summary of the capability area once requirements stabilise. -->

Advanced intelligence and resilience features: custom link types, AI-assisted
link-type inference and auto-tagging, graceful degradation when the database is
unavailable, and self-healing index drift correction.
